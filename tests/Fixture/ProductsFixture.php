...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 32, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '商品種別', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start_selling_at' => '2020-04-22 07:55:13',
                'end_of_sale_at' => '2020-04-22 07:55:13',
                'can_order' => 1,
                'quantity_per_lot' => 1,
                'min_order_lot_quantity' => 1,
                'created' => '2020-04-22 07:55:13',
                'modified' => '2020-04-22 07:55:13',
            ],
        ];
        parent::init();
    }
